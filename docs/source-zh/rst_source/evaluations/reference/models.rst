...
.. list-table::
   ...
   * - OpenWAM
     - ``openwam``
     - ``libero_spatial_openwam_eval``、``libero_object_openwam_eval``、``libero_goal_openwam_eval``、``libero_10_openwam_eval``、``robotwin_click_bell_openwam_eval``、``robotwin_place_empty_cup_openwam_eval``
